...
public sealed class EndpointRegistrationGenerator : IIncrementalGenerator
{
    ...
    private static string Emit(IReadOnlyList<EndpointModel> models)
    {
        ...
        foreach (var ep in models.Where(m => m.IsFeature))
        {
            ...
            sb.AppendLine("                    {");
            sb.AppendLine("                        { \"validation.error.count\", validation.Errors.Count },");
            sb.AppendLine("                        { \"validation.fields\", global::System.String.Join(\",\", errors.Keys) },");
            sb.AppendLine("                        { \"validation.failure.message\", \"Validation failed\" },");
            sb.AppendLine("                        { \"validation.failure.details.type\", \"FluentValidation\" },");
            sb.AppendLine("                        { \"validation.failure.details\", global::System.String.Join(\" | \", validation.Errors.Select(e => $\"{e.PropertyName}:{e.ErrorMessage}\")) }");
            sb.AppendLine("                    };");
            sb.AppendLine();
            sb.AppendLine("                    activity.AddEvent(new global::System.Diagnostics.ActivityEvent(\"validation.failed\", tags: tags));");
            sb.AppendLine("                }");
            sb.AppendLine();
            ...
            sb.AppendLine("        if (outcome.Status != global::System.Net.HttpStatusCode.OK)");
            sb.AppendLine("        {");
            sb.AppendLine("            var activity = global::System.Diagnostics.Activity.Current;");
            sb.AppendLine("            if (activity != null)");
            sb.AppendLine("            {");
            sb.AppendLine("                var tags = new global::System.Diagnostics.ActivityTagsCollection");
            sb.AppendLine("                {");
            sb.AppendLine("                    { \"handler.failure.message\", global::System.String.IsNullOrWhiteSpace(outcome.Failure?.Message) ? \"n/a\" : outcome.Failure!.Message },");
            sb.AppendLine("                    { \"handler.failure.details.type\", outcome.Failure?.Details?.GetType().FullName ?? \"n/a\" },");
            sb.AppendLine("                    { \"handler.failure.details\", outcome.Failure?.Details?.ToString() ?? \"n/a\" }");
            sb.AppendLine("                };");
            sb.AppendLine("                activity.AddEvent(new global::System.Diagnostics.ActivityEvent(\"handler.outcome\", tags: tags));");
            sb.AppendLine("            }");
            sb.AppendLine("        }");
